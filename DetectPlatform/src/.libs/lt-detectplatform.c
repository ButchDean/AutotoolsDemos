...
/* ./.libs/lt-detectplatform.c - temporary wrapper executable for .libs/detectplatform
   Generated by libtool (GNU libtool) 2.4.6

   The detectplatform program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "detectplatform"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# detectplatform - temporary wrapper script for .libs/detectplatform\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6\n", f);
  fputs ("#\n", f);
  fputs ("# The detectplatform program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"detectplatform:detectplatform:$LINENO: libtool wrapper (GNU libtool) ", f);
  fputs ("2.4.6\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"detectplatform:detectplatform:$LINENO: newargv[$lt_dump_args_N]: $lt", f);
  fputs ("_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"detectplatform:detectplatform:$LINENO: newargv[0]: $progdir/$pro", f);
  fputs ("gram\" 1>&2\n", f);
